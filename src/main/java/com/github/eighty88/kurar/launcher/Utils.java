...
public class Utils {
    ...
    public static File getKurarDirectory() {
        return new File(getWorkingDirectory(), "Kurar");
    }
    ...
    public void downloadVersionJson() throws Exception {
        ...
        try {
            ...
            URL url = new URL("https://github.com/Palpunte-Union/KurarClient-Binary/releases/download/" + readURL() + "/KurarClient.json");
            byteChannel = Channels.newChannel(url.openStream());
